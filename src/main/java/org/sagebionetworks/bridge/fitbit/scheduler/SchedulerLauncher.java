...
public class SchedulerLauncher {
    ...
    private static void launch(String schedulerName) throws IOException {
        ...
        Table ddbFitBitConfigTable = ddbClient.getTable("FitBit-Scheduler-Config");

        // set up SQS client
        AmazonSQS sqsClient = AmazonSQSClientBuilder.defaultClient();

        // set up scheduler
        BridgeFitBitScheduler scheduler = new BridgeFitBitScheduler();
        scheduler.setDdbFitBitConfigTable(ddbFitBitConfigTable);
